    ...
    <Card className="border-border-secondary shadow-sm rounded-2xl overflow-hidden">
      ...
      <CardContent className="px-4 sm:px-6 pb-6">
        ...
        {!loading && chips.length === 0 && (
          <div className="py-16 text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-sm text-muted-foreground mt-1 max-w-[250px] mx-auto">
              Start by adding your first chip,for getting the intent of the customer thus helping AI generate review.
            </p>
          </div>
        )}
        ...
        {!loading && chips.length > 0 && (
         ...
         <h6 className="text-lg font-semibold text-heading mb-4">Active Chips</h6>         
